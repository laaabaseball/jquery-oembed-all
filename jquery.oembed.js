(function($) {
    ...
    function embedCode(container, externalUrl, embedProvider) {
      if ($('#jqoembeddata').data(externalUrl)!=undefined && embedProvider.embedtag.tag!='iframe'){
        ...
        if(embedProvider.embedtag.tag!==''){
		  ...
		  if(embedProvider.name='vine') {}
		  else{
		  if(!embedProvider.nocache) src += '&gkurlcache='+rand(5);
		  }
    ...
    //Video
	new $.fn.oembed.OEmbedProvider("xnxx", "video", ["xnxx\\.com/video.+"], "http://flashservice.xvideos.com/embedframe/$1", {
        templateRegex: /.*com\/video([\w\-]+)\/([\w\-]+).*/,embedtag: {tag: 'iframe',width: '510',height: '400'}}), 
	new $.fn.oembed.OEmbedProvider("xhamster", "video", ["xhamster\\.com/movies.+"], "http://xhamster.com/xembed.php?video=$1", {
        templateRegex: /.*com\/movies\/([\w\-]+)\/([\w\-]+).*/,embedtag: {tag: 'iframe',width: '510',height: '400'}}), 
	new $.fn.oembed.OEmbedProvider("cliphunter", "video", ["cliphunter\\.com/w/.+"], "http://cliphunter.com/embed/$1", {
        templateRegex: /.*com\/w\/([\w\-]+)\/([\w\-]+).*/,embedtag: {tag: 'iframe',width: '608',height: '481'}}), 
	new $.fn.oembed.OEmbedProvider("pornhub", "video", ["pornhub\\.com/view_video.php\\?viewkey=.+"], "http://www.pornhub.com/embed/$1", {
        templateRegex: /.*viewkey=(.+)/,embedtag: {tag: 'iframe',width: '608',height: '468'}}), 
	//new $.fn.oembed.OEmbedProvider("youjizz", "video", ["youjizz\\.com/videos\\.+"], "http://www.youjizz.com/videos/embed/$1", {
        //templateRegex: /.*-(.+).html/,embedtag: {tag: 'iframe',width: '704',height: '550'}}), 
		
    new $.fn.oembed.OEmbedProvider("youtube", "video", ["youtube\\.com/watch.+v=[\\w-]+&?", "youtu\\.be/[\\w-]+"], 'http://www.youtube.com/oembed', {useYQL:'json'}), 
    new $.fn.oembed.OEmbedProvider("youtubeiframe", "video", ["youtube.com/embed"],  "$1?wmode=transparent",
      {templateRegex:/(.*)/,embedtag : {tag: 'iframe', width:'560',height: '315'}}), 
    ...
    new $.fn.oembed.OEmbedProvider("xtranormal", "video", ["xtranormal\\.com/watch/.+"], "http://www.xtranormal.com/xtraplayr/$1/$2", {
        templateRegex: /.*com\/watch\/([\w\-]+)\/([\w\-]+).*/,embedtag: {tag: 'iframe',width: '320',height: '269'}}), 				//	new 	  	  	  
    ...
    new $.fn.oembed.OEmbedProvider("youku", "video", ["v.youku.com/v_show/id_.+"],"http://player.youku.com/player.php/sid/$1/v.swf",
      {templateRegex:/.*id_(.+)\.html.*/, embedtag : {width:480,height:400, nocache:1 }}), 
	   ...
	   new $.fn.oembed.OEmbedProvider("vine", "video", ["vine\\.co/v/.+"],"https://vine.co/v/$1/embed/simple",
      {templateRegex:/.*v\/([^\/]+).*/ ,embedtag : {tag:'iframe',width:600,height: 600, nocache:1 }}), 
    ...
    {yql:{xpath:"json", from:'json'
		...
		new $.fn.oembed.OEmbedProvider("instagram", "photo", ["instagr\\.?am(\\.com)?/.+"], "http://api.instagram.com/oembed"),
		 new $.fn.oembed.OEmbedProvider("imgur.com", "photo", ["imgur\\.com/gallery/.+"],"http://imgur.com/$1.jpg",
      {templateRegex:/.*gallery\/([^\/]+).*/ , embedtag : {tag:'img'},nocache:1}), 
		new $.fn.oembed.OEmbedProvider("imgurlink", "photo", ["imgur\\.com/.+"], "http://i.imgur.com/$1.jpg", {templateRegex:/.*com\/([^\/]+).*/, embedtag : {tag:'img'},nocache:1}),
		
		new $.fn.oembed.OEmbedProvider("livememe", "photo", ["livememe\\.com/.+"], "http://i.lvme.me/$1.jpg", {templateRegex:/.*com\/([^\/]+).*/, embedtag : {tag:'img'}}),
...
document.body.appendChild(css);
    ...
    new $.fn.oembed.OEmbedProvider("googlecalendar", "rich", ["www.google.com/calendar/embed?.+"],"$1",
	  ...
	  new $.fn.oembed.OEmbedProvider("pdf", "rich", [".+.pdf"],"$1",
      {templateRegex:/(.*)/ ,embedtag : {tag: 'iframe', width:'800',height: '600'}
      }),
